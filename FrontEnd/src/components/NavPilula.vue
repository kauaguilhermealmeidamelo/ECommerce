...
.pilula__item:hover { background: var(--cor-fundo); color: var(--cor-texto); }
.pilula__item--ativo { background: var(--cor-primaria); color: #fff; }
.pilula__item--ativo:hover { background: var(--cor-primaria); color: #fff; }
...
.pilula__item--ativo .pilula__contador { background: #fff; color: var(--cor-primaria); }
