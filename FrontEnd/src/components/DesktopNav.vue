...
.pilula__item:hover { background: #fafafa; color: var(--ink); }
.pilula__item--ativo { background: var(--blue-600); color: #fff; box-shadow: 0 4px 12px rgba(37,99,235,.3); }
.pilula__item--ativo:hover { background: var(--blue-600); color: #fff; }
.pilula__icone { font-size: 1rem; line-height: 1; }
.pilula__label { font-size: .68rem; font-weight: 700; white-space: nowrap; }
.pilula__contador {
...
.pilula__item--ativo .pilula__contador { background: #fff; color: var(--blue-600); }
