<template>
  <div class="autenticacao">
    ...
    <p class="autenticacao__subtitulo">
      Cadastre-se para acompanhar seus pedidos e agilizar suas próximas compras.
    </p>
    ...
    <p class="autenticacao__rodape">
      Já tem conta?
      <router-link :to="{ name: 'login-cliente' }">Entrar</router-link>
    </p>
  </div>
</template>
...
async function cadastrar() {
  ...
  try {
    ...
    erro.value = erros
      ...
      : "Não foi possível criar sua conta. Confira os dados.";
  } finally {
