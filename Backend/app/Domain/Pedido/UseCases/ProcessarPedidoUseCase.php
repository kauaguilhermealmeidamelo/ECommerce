...
class ProcessarPedidoUseCase
{
    ...
    public function __construct(private readonly ConfiguracaoLojaUseCase $configuracaoLojaUseCase)
    {
    }
    ...
    private function aprovar(Pedido $pedido, array $pagamento, ?string $metodo): void
    {
        ...
        $this->configuracaoLojaUseCase->desativarProdutosSeConfigurado($pedido);
    }
