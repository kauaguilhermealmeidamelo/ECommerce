...
use App\Domain\Pedido\UseCases\GerenciarCarrinhoUseCase;
use App\Domain\Produto\UseCases\GerenciarEntregaUseCase;
use App\Domain\Pagamento\UseCases\ProcessarPagamentoMercadoPagoUseCase;
use App\Domain\Pedido\UseCases\ProcessarPedidoUseCase;
...
class CheckoutController extends Controller
{
    public function __construct(
        private readonly GerenciarCarrinhoUseCase $carrinhoService,
        private readonly GerenciarEntregaUseCase $entregaService,
        private readonly ProcessarPedidoUseCase $pedidoService,
        private readonly ProcessarPagamentoMercadoPagoUseCase $mercadoPagoService,
    ) {
    }
